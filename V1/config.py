...
# Whether this process runs the async delivery worker (only one process per
# gateway should — start_all sets false for the mTLS message process).
RUN_WORKER = settings.get_bool("SG_RUN_WORKER", "security_gateway", "run_worker", True)
